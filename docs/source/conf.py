#!/usr/bin/env python
#
# owl documentation build configuration file, created by
...
# Add owl to sys.path to avoid having to full
# install owl for autodoc.
# Full install of owl will burst memory limit on ReadTheDocs.
...
project = "owl"
copyright = "2022, Carmen Alvarez-Castro"
author = "Carmen Alvarez-Castro"
...
version = owl.__version__
# The full version, including alpha/beta/rc tags.
release = owl.__version__
